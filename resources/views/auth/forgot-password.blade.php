@section('title')
    <title>Find it | Forgotten Password</title>
@endsection
{{-- <x-guest-layout>
					...
					<div class=" main-content-area">
						<div class="wrap-login-item ">
							<div class="login-form form-item form-stl">
                                ...
                                <x-jet-validation-errors class="mb-4 alert alert-login" />
								...
								<form name="frm-login" method="POST" action="{{ route('password.email') }}">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-login-email" name="email" placeholder="Type your email address" :value="old('email')" required autofocus >
									</fieldset>

@section('title')
    <title>Find it | {{ $product->name }}</title>
@endsection
<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                <li class="item-link"><a href="{{ ('page.home') }}" class="link">home</a></li>
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0)
                            <div class="wrap-price">
                                <span class="product-price">{{ number_format($product->sale_price, 0, '', ' ') }} Fcfa</span>
                                <del>
                                    <span class="product-price reg-price">{{ $product->getFormatedPrice() }}</span>
                                </del>
                            </div>
                        @else
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Disponibilité:
                                @if ($product->stock_status === "instock")
                                    <b style="color: rgb(3, 189, 3)">En stock</b>
                                @else

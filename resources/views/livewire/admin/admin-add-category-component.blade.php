...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-folder mx-1"></i>Ajouter une catégorie</h1>

        <a href="{{ route('admin.categories') }}" class="btn btn-primary btn-icon-split btn-sm d-none d-sm-inline-block pr-2">
            <span class="icon">

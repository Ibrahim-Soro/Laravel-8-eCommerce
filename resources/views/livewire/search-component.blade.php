        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">Tous les articles</h1>

                    <div class="wrap-right">

                        <div class="sort-item orderby " style="margin-top: 5px">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                <option value="default" selected="selected">Default sorting</option>
                                <option value="date">Trier par: Articles récents</option>
                                <option value="price">Trier par: Prix Croissant</option>
                                <option value="price-desc">Trier par: Prix Décroissant</option>
                            </select>
                        </div>

                        <div class="sort-item product-per-page" style="margin-top: 5px">
                            <select name="post-per-page" class="use-chosen" wire:model="pagesize">
                                <option value="12" selected="selected">12 articles par page</option>
                                <option value="16">16 articles par page</option>
                                ...
                                <option value="30">30 articles par page</option>
                                <option value="32">32 articles par page</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <ul class="product-list grid-products equal-container">
                        ...
                        @if ($products->count() > 0)
                            ...
                            @endforeach
                        @else
                            <div class="product-list grid-products equal-container" style="margin-top: 3rem">
                                <div class="col-xs-12 rounded">
                                    <div class="aboutus-box-score equal-elem ">
                                        ...
                                        <span class="sub-title" style="font-weight: bold">Aucun produit ne correspond à votre recherche ...</span>
                                    </div>
                                </div>
                            </div>
                        @endif
